...
def plot_images(images, cls_true, cls_pred=None):
    ...
    for i, ax in enumerate(axes.flat):
        # Plot image.
        ax.imshow(images[i].cpu().numpy().reshape(img_shape), cmap='binary')
...
test(test_dataloader, model, cost, show_example_errors=True)

#optimize(90, train_dataloader, model, cost, optimizer)
